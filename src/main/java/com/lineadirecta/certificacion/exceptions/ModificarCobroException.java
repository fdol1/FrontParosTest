...
public class ModificarCobroException extends RuntimeException{

    private static final Severidad severidad = SEVERIDAD_MEDIA;

    private static final String ERROR = "Error al modificar el cobro";

    public ModificarCobroException(String mensaje, Throwable motivo){
