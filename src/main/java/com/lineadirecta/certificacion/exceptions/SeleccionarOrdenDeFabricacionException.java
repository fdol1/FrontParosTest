...
public class SeleccionarOrdenDeFabricacionException extends RuntimeException{

    private static final Severidad severidad = SEVERIDAD_MEDIA;

    private static final String ERROR = "Error al seleccionar orden de fabricacion";

    public SeleccionarOrdenDeFabricacionException(String mensaje, Throwable motivo){
